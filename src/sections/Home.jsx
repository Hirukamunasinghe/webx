  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-[-270px] md:mt-[-480px] lg:mt-[-670px] sm:mt-[-300px]">
        <div className={`text-xs md:text-2xl lg:text-5xl text-left lg:text-center lg:pt-[0px] text-customWhite font-bold typewriter-text transition-opacity duration-1000 ${showText ? 'opacity-100' : 'opacity-0'}`}>
